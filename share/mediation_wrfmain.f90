...
SUBROUTINE med_add_config_info_to_grid ( grid )
 ...
 grid % gwd_diags_used             = model_config_rec % gwd_diags_used 
 ...
 grid % ccnty                      = model_config_rec % ccnty 
 ...
 grid % ra_sw_eclipse              = model_config_rec % ra_sw_eclipse 
 grid % ghg_input                  = model_config_rec % ghg_input 
 ...
 grid % num_pft_clm                = model_config_rec % num_pft_clm 
 grid % input_pft                  = model_config_rec % input_pft 
 ...
 grid % num_urban_ngr              = model_config_rec % num_urban_ngr 
 ...
 grid % urban_map_zgrd             = model_config_rec % urban_map_zgrd 
 ...
 grid % use_wudapt_lcz             = model_config_rec % use_wudapt_lcz 
 ...
 grid % qna_update                 = model_config_rec % qna_update 
 ...
 grid % couple_farms               = model_config_rec % couple_farms 
 ...
 grid % shalwater_z0               = model_config_rec % shalwater_z0 (grid%id)
 grid % shalwater_depth            = model_config_rec % shalwater_depth 
 ...
 grid % aer_init_opt               = model_config_rec % aer_init_opt 
 grid % wif_fire_emit              = model_config_rec % wif_fire_emit 
 grid % aer_fire_emit_opt          = model_config_rec % aer_fire_emit_opt 
 grid % wif_fire_inj               = model_config_rec % wif_fire_inj (grid%id)
 grid % use_mp_re                  = model_config_rec % use_mp_re 
 grid % insert_init_cloud          = model_config_rec % insert_init_cloud 
 ...
 grid % acc_phy_tend               = model_config_rec % acc_phy_tend (grid%id)
 grid % madwrf_opt                 = model_config_rec % madwrf_opt 
 grid % madwrf_dt_relax            = model_config_rec % madwrf_dt_relax 
 grid % madwrf_dt_nudge            = model_config_rec % madwrf_dt_nudge 
 grid % madwrf_cldinit             = model_config_rec % madwrf_cldinit 
 ...
 grid % opt_irr                    = model_config_rec % opt_irr 
 grid % opt_irrm                   = model_config_rec % opt_irrm 
 grid % opt_infdv                  = model_config_rec % opt_infdv 
 grid % opt_tdrn                   = model_config_rec % opt_tdrn 
 grid % soiltstep                  = model_config_rec % soiltstep 
 grid % wtddt                      = model_config_rec % wtddt (grid%id)
 grid % noahmp_acc_dt              = model_config_rec % noahmp_acc_dt 
 grid % noahmp_output              = model_config_rec % noahmp_output 
 ...
 grid % w_crit_cfl                 = model_config_rec % w_crit_cfl 
 grid % zadvect_implicit           = model_config_rec % zadvect_implicit 
 ...
 grid % gwd_diags                  = model_config_rec % gwd_diags 
 ...
 grid % phi_adv_z                  = model_config_rec % phi_adv_z (grid%id)
 ...
 grid % fs_array_maxsize           = model_config_rec % fs_array_maxsize 
 grid % fs_firebrand_gen_lim       = model_config_rec % fs_firebrand_gen_lim 
 grid % fs_firebrand_gen_dt        = model_config_rec % fs_firebrand_gen_dt 
 grid % fs_firebrand_gen_levels    = model_config_rec % fs_firebrand_gen_levels 
 grid % fs_firebrand_gen_maxhgt    = model_config_rec % fs_firebrand_gen_maxhgt 
 grid % fs_firebrand_gen_levrand   = model_config_rec % fs_firebrand_gen_levrand 
 grid % fs_firebrand_gen_levrand_seed = model_config_rec % fs_firebrand_gen_levrand_seed 
 grid % fs_firebrand_gen_mom3d_dt  = model_config_rec % fs_firebrand_gen_mom3d_dt 
 grid % fs_firebrand_gen_prop_diam = model_config_rec % fs_firebrand_gen_prop_diam 
 grid % fs_firebrand_gen_prop_effd = model_config_rec % fs_firebrand_gen_prop_effd 
 grid % fs_firebrand_gen_prop_temp = model_config_rec % fs_firebrand_gen_prop_temp 
 grid % fs_firebrand_gen_prop_tvel = model_config_rec % fs_firebrand_gen_prop_tvel 
 grid % fs_firebrand_dens          = model_config_rec % fs_firebrand_dens 
 grid % fs_firebrand_dens_char     = model_config_rec % fs_firebrand_dens_char 
 grid % fs_firebrand_max_life_dt   = model_config_rec % fs_firebrand_max_life_dt 
 grid % fs_firebrand_land_hgt      = model_config_rec % fs_firebrand_land_hgt 
 grid % fuel_crosswalk             = model_config_rec % fuel_crosswalk (grid%id)
 grid % do_avgflx_em               = model_config_rec % do_avgflx_em (grid%id)
 grid % do_avgflx_cugd             = model_config_rec % do_avgflx_cugd (grid%id)
 grid % multi_perturb              = model_config_rec % multi_perturb (grid%id)
 grid % pert_farms                 = model_config_rec % pert_farms (grid%id)
 grid % pert_farms_albedo          = model_config_rec % pert_farms_albedo (grid%id)
 grid % pert_farms_aod             = model_config_rec % pert_farms_aod (grid%id)
 grid % pert_farms_angexp          = model_config_rec % pert_farms_angexp (grid%id)
 grid % pert_farms_aerasy          = model_config_rec % pert_farms_aerasy (grid%id)
 grid % pert_farms_qv              = model_config_rec % pert_farms_qv (grid%id)
 grid % pert_farms_qc              = model_config_rec % pert_farms_qc (grid%id)
 grid % pert_farms_qs              = model_config_rec % pert_farms_qs (grid%id)
 grid % pert_deng                  = model_config_rec % pert_deng (grid%id)
 grid % pert_deng_qv               = model_config_rec % pert_deng_qv (grid%id)
 grid % pert_deng_qc               = model_config_rec % pert_deng_qc (grid%id)
 grid % pert_deng_t                = model_config_rec % pert_deng_t (grid%id)
 grid % pert_deng_w                = model_config_rec % pert_deng_w (grid%id)
 grid % pert_mynn                  = model_config_rec % pert_mynn (grid%id)
 grid % pert_mynn_qv               = model_config_rec % pert_mynn_qv (grid%id)
 grid % pert_mynn_qc               = model_config_rec % pert_mynn_qc (grid%id)
 grid % pert_mynn_t                = model_config_rec % pert_mynn_t (grid%id)
 grid % pert_mynn_qke              = model_config_rec % pert_mynn_qke (grid%id)
 grid % pert_noah                  = model_config_rec % pert_noah (grid%id)
 grid % pert_noah_qv               = model_config_rec % pert_noah_qv (grid%id)
 grid % pert_noah_t                = model_config_rec % pert_noah_t (grid%id)
 grid % pert_noah_smois            = model_config_rec % pert_noah_smois (grid%id)
 grid % pert_noah_tslb             = model_config_rec % pert_noah_tslb (grid%id)
 grid % pert_thom                  = model_config_rec % pert_thom (grid%id)
 grid % pert_thom_qv               = model_config_rec % pert_thom_qv (grid%id)
 grid % pert_thom_qc               = model_config_rec % pert_thom_qc (grid%id)
 grid % pert_thom_qi               = model_config_rec % pert_thom_qi (grid%id)
 grid % pert_thom_qs               = model_config_rec % pert_thom_qs (grid%id)
 grid % pert_thom_ni               = model_config_rec % pert_thom_ni (grid%id)
 grid % pert_cld3                  = model_config_rec % pert_cld3 (grid%id)
 grid % pert_cld3_qv               = model_config_rec % pert_cld3_qv (grid%id)
 grid % pert_cld3_t                = model_config_rec % pert_cld3_t (grid%id)
 grid % spdt                       = model_config_rec % spdt (grid%id)
 grid % num_pert_3d                = model_config_rec % num_pert_3d 
 ...
 grid % wrf_cmaq_option            = model_config_rec % wrf_cmaq_option 
 grid % wrf_cmaq_freq              = model_config_rec % wrf_cmaq_freq 
 grid % met_file_tstep             = model_config_rec % met_file_tstep 
 grid % direct_sw_feedback         = model_config_rec % direct_sw_feedback 
 grid % feedback_restart           = model_config_rec % feedback_restart 
