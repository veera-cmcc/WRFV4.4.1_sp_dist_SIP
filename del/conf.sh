...
# wrf
#export WRF_DIR=`pwd`
export WRK_DIR=/users_home/cmcc/${USER}/source/WRFV4.4.1_JUNO
export WRF_DIR=${WRK_DIR}/WRFV4.4.1
...
export NETCDF=/users_home/cmcc/vr25423/source/WRFV4.4.1_JUNO/WRFV4.4.1/NETCDF
export PATH=/users_home/cmcc/vr25423/source/WRFV4.4.1_JUNO/WRFV4.4.1/NETCDF/bin:$PATH
