  ...
  ips, ipe, jps, jpe, kps, kpe )
   ...
   DO ij = 1, grid%num_tiles
     ...
     CALL phy_init (  grid%id , config_flags, grid%DT, grid%RESTART, grid%znw, grid%znu,   &
                      ...
                      z_at_q, grid%alt, grid%qnwfa2d, grid%qnbca2d,     & 
                      scalar(ims,kms,jms,1), num_scalar,                & 
                      grid%re_cloud, grid%re_ice, grid%re_snow,         & 
                      grid%has_reqc, grid%has_reqi, grid%has_reqs,      & 
                      grid%phb,grid%ph_2,grid%p,grid%pb,                & 
                      moist(:,:,:,P_QV),config_flags%CCNTY,             & 
                      scalar(:,:,:,P_QDCN),scalar(:,:,:,P_QTCN),        & 
                      scalar(:,:,:,P_QCCN),scalar(:,:,:,P_QRCN),        & 
                      scalar(:,:,:,P_QNIN),                             & 
                      ...
                      grid%QRAINXY,                                                             &   
                      grid%WSLAKEXY, grid%ZWTXY, grid%WAXY, grid%WTXY, grid%LFMASSXY,           &   
                      grid%RTMASSXY,                                                            &   
                      ...
                      config_flags%opt_irr, config_flags%opt_irrm,                              &   
                      grid%IRNUMSI, grid%IRNUMMI, grid%IRNUMFI, grid%IRWATSI, grid%IRWATMI,     &   
                      grid%IRWATFI, grid%IRELOSS, grid%IRSIVOL, grid%IRMIVOL, grid%IRFIVOL,     &   
                      grid%IRRSPLH, grid%qtdrain,                                               &   
                      grid%gecros_state,                                                        &   
                      ...
                      grid%EP_PV_URB3D,grid%T_PV_URB3D,                                  & 
                      grid%TRV_URB4D,grid%QR_URB4D,grid%QGR_URB3D,grid%TGR_URB3D,        & 
                      grid%DRAIN_URB4D,grid%DRAINGR_URB3D,grid%SFRV_URB3D,               & 
                      grid%LFRV_URB3D,grid%DGR_URB3D,grid%DG_URB3D,grid%LFR_URB3D,     & 
                      grid%LFG_URB3D,                                                  & 
                      ...
                      grid%water_depth,  grid%BATHYMETRY_FLAG, grid%shalwater_z0,grid%shalwater_depth, & 
