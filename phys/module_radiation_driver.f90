...
CONTAINS
   ...
   INTEGER,      INTENT(IN   )    ::   cldovrlp, idcor           
  ...
  real, dimension( ims:ime, jms:jme, 1:4 )  :: sflxd    
        ...
        case (goddardlwscheme)
            ...
            IF ( mp_physics .NE. nuwrf4icescheme ) THEN
             ...
             CALL goddardrad(sw_or_lw='lw',dx=dx                  &
                    ...
                    ,rer3d=re_rain_gsfc,res3d=re_snow_gsfc             & 
                    ,reg3d=re_graupel_gsfc,reh3d=re_hail_gsfc          & 
                    ,erbe_out=erbe_out                                 &
     ...
     swrad_select: SELECT CASE(sw_physics)
        ...
        case (goddardswscheme)
             ...
             CALL goddardrad(sw_or_lw='sw',dx=dx                  &
                    ...
                    ,reg3d=re_graupel_gsfc,reh3d=re_hail_gsfc          & 
                    ,erbe_out=erbe_out                                 &
                    ,cod2d_out=cod2d_out,ctop2d_out=ctop2d_out         & 
                    ,sflxd=sflxd                                       & 
...
'arguments not present for calling cam radiation' )
        ...
        CASE (RRTMG_SWSCHEME)
             ...
             CALL RRTMG_SWRAD(                                         &
                     ...
                     obscur=obscur_loc,                                 & 
                     xcoszen=coszen,yr=yr,julian=julian,mp_physics=mp_physics, &   
                     proceed_cmaq_sw=proceed_cmaq_sw,                   & 
                     nmode=3,                                           & 
                     mass_ws_i=mass_ws_i,                               & 
                     mass_ws_j=mass_ws_j,                               & 
                     mass_ws_k=mass_ws_k,                               & 
                     ...
                     mass_ss_j=mass_ss_j,                               & 
                     mass_ss_k=mass_ss_k,                               & 
                     mass_h2o_i=mass_h2o_i,                             & 
                     mass_h2o_j=mass_h2o_j,                             & 
                     mass_h2o_k=mass_h2o_k,                             & 
                     dgn_i=dgn_i,                                       & 
                     dgn_j=dgn_j,                                       & 
                     dgn_k=dgn_k,                                       & 
                     sig_i=sig_i,                                       & 
                     sig_j=sig_j,                                       & 
                     sig_k=sig_k,                                       & 
                     gtauxar_01=sw_gtauxar_01,                          & 
                     gtauxar_02=sw_gtauxar_02,                          & 
                     gtauxar_03=sw_gtauxar_03,                          & 
                     gtauxar_04=sw_gtauxar_04,                          & 
                     gtauxar_05=sw_gtauxar_05,                          & 
                     asy_fac_01=sw_asy_fac_01,                          & 
                     asy_fac_02=sw_asy_fac_02,                          & 
                     asy_fac_03=sw_asy_fac_03,                          & 
                     asy_fac_04=sw_asy_fac_04,                          & 
                     asy_fac_05=sw_asy_fac_05,                          & 
                     ssa_01=sw_ssa_01,                                  & 
                     ssa_02=sw_ssa_02,                                  & 
                     ssa_03=sw_ssa_03,                                  & 
                     ssa_04=sw_ssa_04,                                  & 
                     ssa_05=sw_ssa_05,                                  & 
                     sw_zbbcddir=sw_zbbcddir,                           & 
                     sw_dirdflux=sw_dirdflux,                           & 
                     sw_difdflux=sw_difdflux                            & 
                                                                        )
...
'Unkonown aer_opt to FARMS. Only options 0, 1, 2, and 3 are supported.')
...
END SUBROUTINE aer_p_int
     ...
     &                      (/10., 60., 70., 80., 85., 90., 95., 99.8/)
      REAL, DIMENSION(rind,4,3) :: lookup_tabl                           
