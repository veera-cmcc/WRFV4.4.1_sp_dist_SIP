...
IF ( ASSOCIATED( grid%qv_largescale_tend ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",2969,&
...
IF ( ASSOCIATED( grid%ht_coarse ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3271,&
...
IF ( ASSOCIATED( grid%dfi_re_hail_gsfc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",3924,&
...
ENDIF
IF ( ASSOCIATED( grid%refkdt_2d_lsm ) ) THEN 
  DEALLOCATE(grid%refkdt_2d_lsm,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",4913,&
'frame/module_domain.f: Failed to deallocate grid%refkdt_2d_lsm. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%slope_2d_lsm ) ) THEN 
  DEALLOCATE(grid%slope_2d_lsm,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",4920,&
'frame/module_domain.f: Failed to deallocate grid%slope_2d_lsm. ')
 endif
ENDIF
IF ( ASSOCIATED( grid%vegfra ) ) THEN 
  DEALLOCATE(grid%vegfra,STAT=ierr)
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",4927,&
...
IF ( ASSOCIATED( grid%sstsk ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5011,&
...
IF ( ASSOCIATED( grid%uoce ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5039,&
...
IF ( ASSOCIATED( grid%dfi_alt ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5158,&
...
IF ( ASSOCIATED( grid%dfi_smois ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5186,&
...
IF ( ASSOCIATED( grid%xxxr_urb2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5284,&
...
IF ( ASSOCIATED( grid%flxhumg_urb2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5354,&
...
IF ( ASSOCIATED( grid%sfw2_urb3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5571,&
...
IF ( ASSOCIATED( grid%tgr_urb3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5627,&
...
IF ( ASSOCIATED( grid%cmgr_sfcdif ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5718,&
...
IF ( ASSOCIATED( grid%coszen ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5746,&
...
IF ( ASSOCIATED( grid%swvisdif ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5802,&
...
IF ( ASSOCIATED( grid%alswvisdif ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5830,&
...
IF ( ASSOCIATED( grid%wwlt_px ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5914,&
...
IF ( ASSOCIATED( grid%clay_px ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5935,&
...
IF ( ASSOCIATED( grid%wstar_ysu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",5991,&
...
IF ( ASSOCIATED( grid%exch_h ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6012,&
...
IF ( ASSOCIATED( grid%uz0 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6054,&
...
IF ( ASSOCIATED( grid%thv_up ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6180,&
...
IF ( ASSOCIATED( grid%v_up ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6215,&
...
IF ( ASSOCIATED( grid%cfm_temf ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6348,&
...
IF ( ASSOCIATED( grid%wm_temf ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6355,&
...
IF ( ASSOCIATED( grid%qdiss ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6383,&
...
IF ( ASSOCIATED( grid%tsq ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6404,&
...
IF ( ASSOCIATED( grid%qsq ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6411,&
...
IF ( ASSOCIATED( grid%cov ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6418,&
...
IF ( ASSOCIATED( grid%edmf_ent ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6467,&
...
IF ( ASSOCIATED( grid%det_thl3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6495,&
...
IF ( ASSOCIATED( grid%dfgdp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6537,&
...
IF ( ASSOCIATED( grid%oc12d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",6593,&
...
IF ( ASSOCIATED( grid%shadowmask ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7826,&
...
IF ( ASSOCIATED( grid%phys_tot ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7882,&
...
IF ( ASSOCIATED( grid%physc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7889,&
...
IF ( ASSOCIATED( grid%acphys_tot ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7931,&
...
IF ( ASSOCIATED( grid%acphyss ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7959,&
...
IF ( ASSOCIATED( grid%sswdn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8057,&
...
IF ( ASSOCIATED( grid%rvshten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8092,&
...
IF ( ASSOCIATED( grid%rqrshten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8113,&
...
IF ( ASSOCIATED( grid%rqsshten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8127,&
...
IF ( ASSOCIATED( grid%rqishten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8134,&
...
IF ( ASSOCIATED( grid%rdcashten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8162,&
...
IF ( ASSOCIATED( grid%rqcdcshten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8169,&
...
IF ( ASSOCIATED( grid%cldtopb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8225,&
...
IF ( ASSOCIATED( grid%wub ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8239,&
...
IF ( ASSOCIATED( grid%kdcldtop ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8281,&
...
IF ( ASSOCIATED( grid%xtime1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8295,&
...
IF ( ASSOCIATED( grid%rqicuten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8372,&
...
IF ( ASSOCIATED( grid%qiconv ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8407,&
...
IF ( ASSOCIATED( grid%hailnc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8505,&
...
IF ( ASSOCIATED( grid%hailncv ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8526,&
...
IF ( ASSOCIATED( grid%mskf_refl_10cm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8540,&
...
IF ( ASSOCIATED( grid%th_old ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8547,&
...
IF ( ASSOCIATED( grid%rhopo3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8575,&
...
IF ( ASSOCIATED( grid%rhopo3d_2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8603,&
...
IF ( ASSOCIATED( grid%itype_2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8652,&
...
IF ( ASSOCIATED( grid%cldfra_sh ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8694,&
...
IF ( ASSOCIATED( grid%uer_kf ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8715,&
...
IF ( ASSOCIATED( grid%apr_capmi ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8785,&
...
IF ( ASSOCIATED( grid%k22_shallow ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8806,&
...
IF ( ASSOCIATED( grid%ktop_shallow ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8820,&
...
IF ( ASSOCIATED( grid%cugd_qvtens ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8883,&
...
IF ( ASSOCIATED( grid%raincv_a ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8918,&
...
IF ( ASSOCIATED( grid%gd_cloud2_a ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8939,&
...
IF ( ASSOCIATED( grid%nr_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",8988,&
...
IF ( ASSOCIATED( grid%efss ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9051,&
...
IF ( ASSOCIATED( grid%ccn7_gs ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9107,&
...
IF ( ASSOCIATED( grid%qi_bl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9121,&
...
IF ( ASSOCIATED( grid%rthratensw ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9163,&
...
IF ( ASSOCIATED( grid%rthratenswc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9170,&
...
IF ( ASSOCIATED( grid%cldt ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9212,&
...
IF ( ASSOCIATED( grid%swdownc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9233,&
...
IF ( ASSOCIATED( grid%swddir2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9282,&
...
IF ( ASSOCIATED( grid%swddnic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9310,&
...
IF ( ASSOCIATED( grid%swddif2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9331,&
...
IF ( ASSOCIATED( grid%bx ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9345,&
...
IF ( ASSOCIATED( grid%coszen_ref ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9366,&
...
IF ( ASSOCIATED( grid%tt2min ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9450,&
...
IF ( ASSOCIATED( grid%q2min ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9478,&
...
IF ( ASSOCIATED( grid%tspduv10max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9583,&
...
IF ( ASSOCIATED( grid%acswuptc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9695,&
...
IF ( ASSOCIATED( grid%aclwdnt ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9758,&
...
IF ( ASSOCIATED( grid%aclwupbc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9779,&
...
IF ( ASSOCIATED( grid%aclwdnb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9786,&
...
IF ( ASSOCIATED( grid%i_aclwuptc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9863,&
...
IF ( ASSOCIATED( grid%i_aclwupbc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9891,&
...
IF ( ASSOCIATED( grid%swupb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9954,&
...
IF ( ASSOCIATED( grid%lwupt ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",9996,&
...
IF ( ASSOCIATED( grid%lwupb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10038,&
...
IF ( ASSOCIATED( grid%xlong_u ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10108,&
...
IF ( ASSOCIATED( grid%cldefi ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10178,&
...
IF ( ASSOCIATED( grid%rthblten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10199,&
...
IF ( ASSOCIATED( grid%flx4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10234,&
...
IF ( ASSOCIATED( grid%tslb_mosaic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10276,&
...
IF ( ASSOCIATED( grid%emiss_mosaic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10339,&
...
IF ( ASSOCIATED( grid%lai_mosaic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10367,&
...
IF ( ASSOCIATED( grid%grdflx_mosaic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10402,&
...
IF ( ASSOCIATED( grid%tbpvs_state ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10542,&
...
IF ( ASSOCIATED( grid%tyr ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10591,&
...
IF ( ASSOCIATED( grid%tlag ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10612,&
...
IF ( ASSOCIATED( grid%cplmask ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10626,&
...
IF ( ASSOCIATED( grid%cka ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10647,&
...
IF ( ASSOCIATED( grid%rmol ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10682,&
...
IF ( ASSOCIATED( grid%mol ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10689,&
...
IF ( ASSOCIATED( grid%capg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10703,&
...
IF ( ASSOCIATED( grid%qvg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10780,&
...
IF ( ASSOCIATED( grid%dew ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10801,&
...
IF ( ASSOCIATED( grid%dfi_snowc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10850,&
...
IF ( ASSOCIATED( grid%mavail ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10857,&
...
IF ( ASSOCIATED( grid%sr ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10871,&
...
IF ( ASSOCIATED( grid%defor12 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",10927,&
...
IF ( ASSOCIATED( grid%rvndgdten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11004,&
...
IF ( ASSOCIATED( grid%fdda3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11039,&
...
IF ( ASSOCIATED( grid%u10_ndg_new ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11060,&
...
IF ( ASSOCIATED( grid%th2_ndg_old ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11095,&
...
IF ( ASSOCIATED( grid%th2_ndg_new ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11102,&
...
IF ( ASSOCIATED( grid%q2_ndg_new ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11116,&
...
IF ( ASSOCIATED( grid%odis_ndg_old ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11172,&
...
IF ( ASSOCIATED( grid%odis_ndg_new ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11186,&
...
IF ( ASSOCIATED( grid%sda_hfx ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11207,&
...
IF ( ASSOCIATED( grid%sda_qfx ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11214,&
...
IF ( ASSOCIATED( grid%emstot ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11263,&
...
IF ( ASSOCIATED( grid%pk1m ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11284,&
...
IF ( ASSOCIATED( grid%grpl_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11340,&
...
IF ( ASSOCIATED( grid%numcolpts ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11361,&
...
IF ( ASSOCIATED( grid%hail_max2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11382,&
...
IF ( ASSOCIATED( grid%t0ml ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11431,&
...
IF ( ASSOCIATED( grid%hml ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",11438,&
...
IF ( ASSOCIATED( grid%forcwlsm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16899,&
...
IF ( ASSOCIATED( grid%acrunsb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16913,&
...
IF ( ASSOCIATED( grid%acqlat ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16948,&
...
IF ( ASSOCIATED( grid%acetlsm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",16962,&
...
IF ( ASSOCIATED( grid%acponding ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17018,&
...
IF ( ASSOCIATED( grid%acsagb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17060,&
...
IF ( ASSOCIATED( grid%acirb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17067,&
...
IF ( ASSOCIATED( grid%acpahb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17095,&
...
IF ( ASSOCIATED( grid%acsagv ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17102,&
...
IF ( ASSOCIATED( grid%acshg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17116,&
...
IF ( ASSOCIATED( grid%acghv ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17130,&
...
IF ( ASSOCIATED( grid%acshc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17158,&
...
IF ( ASSOCIATED( grid%aclwuplsm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17207,&
...
IF ( ASSOCIATED( grid%acshflsm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17214,&
...
IF ( ASSOCIATED( grid%acpahlsm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17235,&
...
IF ( ASSOCIATED( grid%soilenergy ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17249,&
...
IF ( ASSOCIATED( grid%acc_ssoil ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17263,&
...
IF ( ASSOCIATED( grid%acc_qinsur ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17270,&
...
IF ( ASSOCIATED( grid%acc_etrani ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17284,&
...
IF ( ASSOCIATED( grid%acc_dwaterxy ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17305,&
...
IF ( ASSOCIATED( grid%planting ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17361,&
...
IF ( ASSOCIATED( grid%season_gdd ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17375,&
...
IF ( ASSOCIATED( grid%td_fraction ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17403,&
...
IF ( ASSOCIATED( grid%qtdrain ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17410,&
...
IF ( ASSOCIATED( grid%irfract ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17417,&
...
IF ( ASSOCIATED( grid%fifract ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17438,&
...
IF ( ASSOCIATED( grid%irnumfi ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17459,&
...
IF ( ASSOCIATED( grid%irmivol ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17494,&
...
IF ( ASSOCIATED( grid%ireloss ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17508,&
...
IF ( ASSOCIATED( grid%irrsplh ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17515,&
...
IF ( ASSOCIATED( grid%kext_qic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17529,&
...
IF ( ASSOCIATED( grid%kext_qid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17543,&
...
IF ( ASSOCIATED( grid%kext_qa ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17571,&
...
IF ( ASSOCIATED( grid%kext_ft_qs ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17599,&
...
IF ( ASSOCIATED( grid%tempc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17620,&
...
IF ( ASSOCIATED( grid%refd ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17655,&
...
IF ( ASSOCIATED( grid%echotop ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17676,&
...
IF ( ASSOCIATED( grid%fzlev ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17683,&
...
IF ( ASSOCIATED( grid%afwa_tornado ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",17991,&
...
IF ( ASSOCIATED( grid%psfc_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18012,&
...
IF ( ASSOCIATED( grid%tsk_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18019,&
...
IF ( ASSOCIATED( grid%pmsl_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18026,&
...
IF ( ASSOCIATED( grid%hfx_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18068,&
...
IF ( ASSOCIATED( grid%swdnb_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18082,&
...
IF ( ASSOCIATED( grid%swupb_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18103,&
...
IF ( ASSOCIATED( grid%lwupt_mean ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18124,&
...
IF ( ASSOCIATED( grid%v10_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18180,&
...
IF ( ASSOCIATED( grid%hfx_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18187,&
...
IF ( ASSOCIATED( grid%swdnb_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18201,&
...
IF ( ASSOCIATED( grid%lwupb_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18215,&
...
IF ( ASSOCIATED( grid%swdnt_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18236,&
...
IF ( ASSOCIATED( grid%lwupt_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18243,&
...
IF ( ASSOCIATED( grid%lwdnt_diurn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18250,&
...
IF ( ASSOCIATED( grid%psfc_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18257,&
...
IF ( ASSOCIATED( grid%t2_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18271,&
...
IF ( ASSOCIATED( grid%th2_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18278,&
...
IF ( ASSOCIATED( grid%u10_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18292,&
...
IF ( ASSOCIATED( grid%lh_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18313,&
...
IF ( ASSOCIATED( grid%lwupb_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18334,&
...
IF ( ASSOCIATED( grid%swupt_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18348,&
...
IF ( ASSOCIATED( grid%swdnt_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18355,&
...
IF ( ASSOCIATED( grid%lwdnt_dtmp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18369,&
...
IF ( ASSOCIATED( grid%induc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18383,&
...
IF ( ASSOCIATED( grid%elecz ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18425,&
...
IF ( ASSOCIATED( grid%light ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18439,&
...
IF ( ASSOCIATED( grid%flshi ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18460,&
...
IF ( ASSOCIATED( grid%flshp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18474,&
...
IF ( ASSOCIATED( grid%field_u_tend_perturb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18481,&
...
IF ( ASSOCIATED( grid%field_t_tend_perturb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18495,&
...
IF ( ASSOCIATED( grid%c1h ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18502,&
...
IF ( ASSOCIATED( grid%c1f ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18516,&
...
IF ( ASSOCIATED( grid%c2f ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18523,&
...
IF ( ASSOCIATED( grid%c4h ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18537,&
...
IF ( ASSOCIATED( grid%pc_2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18572,&
...
IF ( ASSOCIATED( grid%pc_btxe ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18619,&
...
IF ( ASSOCIATED( grid%pc_btys ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18627,&
...
IF ( ASSOCIATED( grid%pc_btye ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",18635,&
   ...
   END SUBROUTINE init_module_domain
      ...
      FUNCTION domain_get_current_time ( grid ) RESULT ( current_time ) 
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",19842,&
      ...
      FUNCTION domain_get_start_time ( grid ) RESULT ( start_time ) 
        ...
        CALL WRFU_ClockGet( grid%domain_clock, StartTime=start_time, &
                            rc=rc )
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",19862,&
      ...
      FUNCTION domain_clockisstoptime ( grid ) RESULT ( is_stop_time ) 
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",20007,&
      ...
      SUBROUTINE domain_clock_get( grid, current_time,                &
        ...
        IF ( PRESENT( time_stepstr_frac ) ) THEN
          ...
          CALL WRFU_TimeIntervalGet( lcl_time_step, timeString=tmp_str, &
                                     Sn=Sn, Sd=Sd, rc=rc )
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",20206,&
              'domain_clock_get:  WRFU_TimeIntervalGet() failed' )
          ENDIF
        ...
        IF ( PRESENT( current_timestr_frac ) ) THEN
          ...
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",20234,&
        ...
        IF ( PRESENT( currentDayOfYearReal ) ) THEN
          ...
          CALL WRFU_TimeGet( lcl_currtime, dayOfYear_r8=currentDayOfYearR8, &
                             rc=rc )
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",20252,&
      ...
      SUBROUTINE domain_alarm_create( grid, alarm_id, interval, &
        ...
        ELSE IF ( (       PRESENT( begin_time ) ) .AND. &
           ...
           all_args = .TRUE.
        ELSE
           CALL wrf_error_fatal3("<stdin>",20388,&
        ...
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",20418,&
      ...
      SUBROUTINE domain_clock_set( grid, current_timestr, &
        ...
        IF ( PRESENT( stop_timestr ) ) THEN
          ...
          CALL WRFU_ClockSet( grid%domain_clock, stopTime=lcl_stoptime, &
                              rc=rc )
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",20458,&
        ...
        IF ( PRESENT( time_step_seconds ) ) THEN
          ...
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",20466,&
          ...
          CALL WRFU_ClockSet ( grid%domain_clock,        &
                               ...
                               rc=rc )
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",20473,&
   ...
   SUBROUTINE get_dims_from_grid_id (  id   &
    ...
    INTEGER, DIMENSION(3), INTENT(INOUT) ::                   &
     ...
     ELSE
        ...
        CALL wrf_error_fatal3("<stdin>",21018,&
TRIM(mess))
     ENDIF
   ...
   SUBROUTINE get_ijk_from_grid_id (  id ,                   &
    ...
    INTEGER, INTENT(OUT) ::                                 &
     ...
     ELSE
        WRITE(mess,*)'internal error: get_ijk_from_grid_id: no such grid id:',id
        CALL wrf_error_fatal3("<stdin>",21062,&
TRIM(mess))
     ENDIF
